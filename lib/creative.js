...
function Creative(type, settings) {
  ...
  if (type == 'CompanionAd' && settings.adSlotID) this.attributes.adSlotID = settings.adSlotID;
  ...
  this.clickThroughTracking;
  this.attachClickThroughTracking = function(url) {
    this.clickThroughTracking = url;
    return this;
  }
  this.clicks = [];
